function [] = startdaq(obj,~,daqObj,inputGains,outputGains,...
    progressDialog,plotHandle,recordingMode)
% function [] = startdaq(obj,~,daqObj,inputGains,outputGains,...
...
% daqObj:           the data acquisition object (output of nidaqboard.m)
...
[input1,~,triggerTime] = readwrite(daqObj,output1,"OutputFormat","Matrix");
